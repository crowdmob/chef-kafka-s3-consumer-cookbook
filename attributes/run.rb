...
node[:deploy].each do |application, _|
  ...
  default[:kafka_s3_consumer][application][:kafka_topic_array] = (node[:deploy][application][:kafka] && node[:deploy][application][:kafka][:topics]) || default[:kafka_s3_consumer][:_application_defaults][:topic_array]
  default[:kafka_s3_consumer][application][:kafka_max_message_size] = (node[:deploy][application][:kafka] && node[:deploy][application][:kafka][:max_message_size]) || default[:kafka_s3_consumer][:_application_defaults][:kafka_max_message_size]
end
